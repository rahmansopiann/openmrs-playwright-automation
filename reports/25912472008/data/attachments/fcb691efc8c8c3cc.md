...
Call log:
  - waiting for locator('#birthdateDay-field') to be visible
    111 × locator resolved to hidden <input min="1" value="" size="5" max="31" type="text" maxlength="2" name="birthdateDay" id="birthdateDay-field" class="day number numeric-range date-component requiredTitle"/>
